...
mod tests {
    ...
    fn cache_key_is_deterministic() {
        let k1 = cache_key("hello", 14.0, "#000", "Helvetica Neue", 280.0);
        let k2 = cache_key("hello", 14.0, "#000", "Helvetica Neue", 280.0);
        assert_eq!(k1, k2);
    }

    #[test]
    fn cache_key_is_64_hex_chars() {
        let k = cache_key("x", 14.0, "#000", "Arial", 100.0);
        assert_eq!(k.len(), 64);
    ...
    fn cache_key_changes_with_content() {
        let k1 = cache_key("foo", 14.0, "#000", "Arial", 100.0);
        let k2 = cache_key("bar", 14.0, "#000", "Arial", 100.0);
        assert_ne!(k1, k2);
    }
    ...
    fn cache_key_changes_with_width() {
        let k1 = cache_key("foo", 14.0, "#000", "Arial", 100.0);
        let k2 = cache_key("foo", 14.0, "#000", "Arial", 200.0);
        assert_ne!(k1, k2);
    }

    #[test]
    fn cache_key_changes_with_font_size() {
        let k1 = cache_key("foo", 13.0, "#000", "Arial", 100.0);
        let k2 = cache_key("foo", 14.0, "#000", "Arial", 100.0);
        assert_ne!(k1, k2);
    }
    ...
    fn cache_key_changes_with_color() {
        let k1 = cache_key("foo", 14.0, "#000", "Arial", 100.0);
        let k2 = cache_key("foo", 14.0, "#fff", "Arial", 100.0);
        assert_ne!(k1, k2);
    }
    ...
    fn cache_key_changes_with_font_family() {
        let k1 = cache_key("foo", 14.0, "#000", "Arial", 100.0);
        let k2 = cache_key("foo", 14.0, "#000", "Menlo", 100.0);
        assert_ne!(k1, k2);
    }
